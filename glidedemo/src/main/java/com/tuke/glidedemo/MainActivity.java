...
import com.tuke.glidedemo.glide.transformations.BitmapCircleUtil;
import com.tuke.glidedemo.glide.transformations.GlideCircleTransform;
import com.tuke.glidedemo.glide.transformations.MyRoundCornersTransformation;
import com.tuke.glidedemo.glide.transformations.RoundCornersTransformation;
...
public class MainActivity extends AppCompatActivity {
	...
	private void glideBase() {
		String imgUrl = "https://pic.cnblogs.com/avatar/93830/20170607145247.png";
		Glide.with(mContext)
				.load(imgUrl)
				//.asBitmap() .asGif()
				//设置等待时的图片
